This folder is used for Udp Server Program by Version Control:Git.
The program is about using socket connection to save the data.
canData.py is about the save data to sqlite3's class.
